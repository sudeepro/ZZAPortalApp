 ...
 * 
 * @Bean public Docket ssnApi() { return new
 ...
 * ApiInfo("Spring Boot REST API", "Spring Boot REST API for SSN Portal", "1.0",
 * "Terms of service", new Contact("Sudeep Sharma",
 * "https://www.ssa.gov/agency/", "sudeepsharma98@gmail.com"),
